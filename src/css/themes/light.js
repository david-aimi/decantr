export const light = {
  ...
  components: {
    ...
    modal: [
      '.d-modal-overlay{position:fixed;inset:0;background:rgba(0,0,0,0.3);display:flex;align-items:center;justify-content:center;z-index:1000;animation:d-fade-in 0.2s ease}',
      '.d-modal-content{background:rgba(255,255,255,0.92);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border:1px solid var(--c5);border-radius:var(--d-radius-lg);box-shadow:0 20px 60px rgba(0,0,0,0.1);max-width:90vw;max-height:85vh;overflow:auto;color:var(--c3);animation:d-slide-in 0.25s cubic-bezier(0.4,0,0.2,1)}',
    ...
    toast: [
      '.d-toast{padding:0.875rem 1rem;border-radius:var(--d-radius);background:var(--c0);border:1px solid var(--c5);color:var(--c3);box-shadow:0 12px 32px rgba(0,0,0,0.08);display:flex;align-items:center;gap:0.75rem;animation:d-toast-in 0.3s cubic-bezier(0.4,0,0.2,1)}',
