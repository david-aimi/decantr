export const retro = {
  ...
  components: {
    ...
    card: [
      ...
      '.d-card-header{font-weight:800;font-size:1.25rem;text-transform:uppercase;letter-spacing:0.05em}',
      '.d-card-footer{border-top:3px solid var(--c3)}'
    ].join(''),
    input: [
      '.d-input-wrap{background:var(--c0);border:3px solid var(--c3);border-radius:var(--d-radius);box-shadow:3px 3px 0 var(--c3);transition:var(--d-transition);display:flex;align-items:center}',
      '.d-input-wrap:focus-within{box-shadow:5px 5px 0 var(--c1);border-color:var(--c1);transform:translate(-1px,-1px)}',
      '.d-input{background:transparent;border:none;outline:none;color:var(--c3);width:100%;font:inherit;font-weight:700}',
    ...
    badge: [
      ...
      '.d-badge-dot{width:8px;height:8px;border-radius:50%;background:var(--c1);border:2px solid var(--c3)}',
    ...
    modal: [
      ...
      '.d-modal-header{font-weight:800;font-size:1.25rem;text-transform:uppercase;letter-spacing:0.05em}',
      '.d-modal-footer{border-top:3px solid var(--c3)}',
      '.d-modal-close{background:transparent;border:3px solid var(--c3);color:var(--c3);cursor:pointer;padding:0.125rem 0.375rem;font-size:1rem;line-height:1;font-weight:800;border-radius:var(--d-radius);box-shadow:2px 2px 0 var(--c3);transition:var(--d-transition)}',
    ...
    textarea: [
      '.d-textarea-wrap{background:var(--c0);border:3px solid var(--c3);border-radius:var(--d-radius);box-shadow:3px 3px 0 var(--c3);transition:var(--d-transition);display:flex}',
      '.d-textarea-wrap:focus-within{box-shadow:5px 5px 0 var(--c1);border-color:var(--c1);transform:translate(-1px,-1px)}',
      '.d-textarea{background:transparent;border:none;outline:none;color:var(--c3);width:100%;font:inherit;font-weight:700;resize:vertical;min-height:5rem}',
    ...
    checkbox: [
      ...
      '.d-checkbox-check{width:22px;height:22px;border:3px solid var(--c3);border-radius:var(--d-radius);background:var(--c0);box-shadow:2px 2px 0 var(--c3);transition:var(--d-transition);display:flex;align-items:center;justify-content:center}',
    ...
    select: [
      '.d-select{background:var(--c0);border:3px solid var(--c3);border-radius:var(--d-radius);box-shadow:3px 3px 0 var(--c3);transition:var(--d-transition);color:var(--c3);padding:0.5rem 0.75rem;font:inherit;font-weight:700;cursor:pointer;width:100%}',
    ...
    tabs: [
      ...
      '.d-tab{padding:0.625rem 1.25rem;font-weight:800;text-transform:uppercase;letter-spacing:0.05em;border:3px solid transparent;border-bottom:none;cursor:pointer;color:var(--c4);background:transparent;transition:var(--d-transition);position:relative;top:3px}',
    ...
    accordion: [
      '.d-accordion-item{border:3px solid var(--c3);border-radius:var(--d-radius);box-shadow:3px 3px 0 var(--c3);margin-bottom:0.5rem;background:var(--c0);transition:var(--d-transition)}',
      '.d-accordion-trigger{width:100%;padding:0.75rem 1rem;font-weight:800;text-transform:uppercase;letter-spacing:0.05em;cursor:pointer;background:var(--c2);border:none;border-bottom:3px solid var(--c3);color:var(--c3);text-align:left;transition:var(--d-transition);font:inherit}',
    ...
    separator: [
      ...
      '.d-separator-label{font-weight:800;text-transform:uppercase;letter-spacing:0.05em;font-size:0.75rem;color:var(--c3);padding:0 0.5rem;background:var(--c0)}',
    ...
    table: [
      ...
      '.d-th{padding:0.75rem 1rem;background:var(--c3);color:var(--c0);font-weight:800;text-transform:uppercase;letter-spacing:0.05em;text-align:left;border-bottom:3px solid var(--c3)}',
    ...
    avatar: [
      '.d-avatar{width:40px;height:40px;border-radius:var(--d-radius);border:3px solid var(--c3);box-shadow:2px 2px 0 var(--c3);overflow:hidden;display:inline-flex;align-items:center;justify-content:center;background:var(--c1);color:#fff;font-weight:800;text-transform:uppercase;font-size:1rem}',
    ...
    tooltip: [
      '.d-tooltip{background:var(--c3);color:var(--c0);padding:0.375rem 0.75rem;border-radius:var(--d-radius);border:3px solid var(--c3);box-shadow:3px 3px 0 color-mix(in srgb,var(--c3) 60%,#000);font-weight:800;font-size:0.8125rem;text-transform:uppercase;letter-spacing:0.05em;z-index:1100}'
    ].join(''),
    alert: [
      '.d-alert{padding:1rem 1.25rem;border:3px solid var(--c3);border-radius:var(--d-radius);box-shadow:4px 4px 0 var(--c3);background:var(--c2);color:var(--c3);font-weight:700;display:flex;align-items:flex-start;gap:0.75rem;position:relative}',
      ...
      '.d-alert-dismiss{background:transparent;border:3px solid var(--c3);cursor:pointer;padding:0.125rem 0.375rem;font-weight:800;border-radius:var(--d-radius);box-shadow:2px 2px 0 var(--c3);transition:var(--d-transition);color:var(--c3);margin-left:auto;font-size:0.875rem;line-height:1}',
      '.d-alert-dismiss:hover{transform:translate(-1px,-1px);box-shadow:3px 3px 0 var(--c3)}'
    ].join(''),
    chip: [
      '.d-chip{background:var(--c2);border:2px solid var(--c3);color:var(--c3);box-shadow:2px 2px 0 var(--c3);font-weight:800;text-transform:uppercase;letter-spacing:0.05em;border-radius:var(--d-radius);transition:var(--d-transition)}',
      ...
      '.d-chip-remove{color:var(--c3);font-weight:800}',
      '.d-chip-remove:hover{color:var(--c9)}'
    ].join(''),
    toast: [
      '.d-toast{padding:0.875rem 1.25rem;border:3px solid var(--c3);border-radius:var(--d-radius);box-shadow:4px 4px 0 var(--c3);background:var(--c0);color:var(--c3);font-weight:700;display:flex;align-items:center;gap:0.75rem;min-width:280px;animation:d-toast-in 0.2s ease}',
      ...
      '.d-toast-close{background:transparent;border:3px solid var(--c3);cursor:pointer;padding:0.125rem 0.375rem;font-weight:800;border-radius:var(--d-radius);box-shadow:2px 2px 0 var(--c3);transition:var(--d-transition);color:var(--c3);margin-left:auto;font-size:0.875rem;line-height:1}',
